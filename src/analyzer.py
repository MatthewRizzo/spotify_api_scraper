...
class Analyzer():
    ...
    def analyze_raw_track_list(self, raw_track_list: List[Dict]) -> Tuple[Dict, Dict]:
        ...
        for raw_track in raw_track_list:
            ...
            cur_num_tracks_by_artist = analyzed_chart_data_artist.get(cur_artist, 0)
            cur_num_tracks_by_artist += 1
            analyzed_chart_data_artist[cur_artist] = cur_num_tracks_by_artist

            cur_num_tracks_in_album = analyzed_chart_data_album.get(cur_album, 0)
            cur_num_tracks_in_album += 1
            analyzed_chart_data_album[cur_album] = cur_num_tracks_in_album
